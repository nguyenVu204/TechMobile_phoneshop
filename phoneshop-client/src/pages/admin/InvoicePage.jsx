        ...
        <div className="flex justify-between items-start border-b-2 border-slate-800 pb-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-black uppercase tracking-wider text-blue-600 leading-none">
                  PhoneShop
                </h1>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm font-medium text-gray-600">
                Hotline: 1900 1234 - Email: support@phoneshop.vn
              </p>
              <p className="text-sm font-medium text-gray-600">
                Website: www.phoneshop.vn
              </p>
            </div>
          </div>
          <div className="text-right">
            <h2 className="text-4xl font-black uppercase text-gray-200 mb-2">
              Hóa đơn
            </h2>
            ...
            <div className="mt-4">
              <span
                className={`px-3 py-1 rounded border text-xs font-bold uppercase ${
        ...
        <table className="w-full text-left mb-8 border-collapse">
          <thead>
            <tr className="bg-slate-800 text-white text-xs uppercase tracking-wider">
              ...
              <th className="p-4 text-right rounded-tr-lg font-bold">
                Thành tiền
              </th>
            </tr>
          </thead>
        ...
        <div className="absolute bottom-12 left-12 right-12 text-center">
          <div className="border-t-2 border-gray-100 pt-8">
            <p className="font-bold text-slate-700 mb-2">
              Cảm ơn quý khách đã tin tưởng PhoneShop!
            </p>
            <p className="text-xs text-gray-500 mb-1">
              Mọi thắc mắc xin vui lòng liên hệ hotline hoặc email hỗ trợ.
            </p>
            <p className="text-xs text-gray-400">
              Hóa đơn điện tử được tạo tự động ngày{" "}
